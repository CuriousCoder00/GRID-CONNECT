  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="flex p-3 min-w-full hover:bg-slate-300 rounded dark:hover:bg-slate-900 gap-3">
        <div className="flex object-cover overflow-hidden rounded-md aspect-video">
          <Image
        ...
        <div className="flex w-full flex-col justify-between py-5">
          <div className="flex w-full flex-col">
            ...
            <span className=" font-light w-full text-sm">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis in praesentium eum numquam provident nisi fuga. Voluptate veniam commodi nostrum!
            </span>
          </div>
          <Gradient/>
      ...
      <div className="flex p-3 min-w-full hover:bg-slate-300 rounded dark:hover:bg-slate-900 gap-3">
        <div className="flex overflow-hidden rounded-md aspect-video">
          <Image
            alt="gaming community"
            width={400}
            height={50}
      ...
      <div className="flex p-3 min-w-full hover:bg-slate-300 rounded dark:hover:bg-slate-900 gap-3">
        <div className="flex object-fit overflow-hidden rounded-md aspect-video">
          <Image
            alt="gaming community"
            width={400}
            height={400}
